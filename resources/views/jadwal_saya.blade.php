...
<body>
    ...
    <table class="table1" align="center">
        ...
        <tbody>
        @foreach($jadwalSaya as $new)
            <tr>
                <td>{{ $new->hari }}</td>
            <td>
                @if($new->waktu == 1) 08:00 - 12:00
                @elseif($new->waktu == 2) 12:00 - 16:00
                @elseif($new->waktu == 3) 16:00 - 20:00
                @elseif($new->waktu == 4) 20:00 - 00:00
                @elseif($new->waktu == 5) 00:00 - 04:00
